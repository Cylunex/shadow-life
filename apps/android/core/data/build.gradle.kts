...
dependencies { api(project(":core:model")); api(libs.room.runtime); api(libs.room.ktx); ksp(libs.room.compiler); implementation(libs.security.crypto); implementation(libs.kotlinx.coroutines.core); testImplementation(libs.junit) }
