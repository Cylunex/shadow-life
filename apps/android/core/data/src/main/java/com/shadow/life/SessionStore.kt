...
class SessionStore(context:Context) {
  ...
  @Synchronized fun isCurrent(expectedGeneration:Long,accountId:String):Boolean=preferences.getLong("session_generation",0)==expectedGeneration&&preferences.getString("active_account",null)==accountId&&preferences.contains(sessionKey(accountId))
