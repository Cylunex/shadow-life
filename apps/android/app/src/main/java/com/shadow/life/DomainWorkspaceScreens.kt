...
@OptIn(ExperimentalMaterial3Api::class)
@Composable fun TravelWorkspaceScreen(overviewState:LoadState<WorkspaceOverview>,recordsState:LoadState<RecordPage>,onRetry:()->Unit,onLoadMore:()->Unit,onBack:()->Unit,onDetail:(LifeDomain,String,String)->Unit,onCapture:(CaptureKind)->Unit){
  var tab by rememberSaveable{mutableStateOf("overview")};val value=(overviewState as? LoadState.Ready)?.value as? WorkspaceOverview.Travel
