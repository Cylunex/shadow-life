...
android { namespace="com.shadow.life"; compileSdk=36
  defaultConfig {
    ...
    buildConfigField("String","SHADOW_FOLIANT_URL",quoted(configured("SHADOW_FOLIANT_URL","")))
    buildConfigField("String","SHADOW_GARDEN_URL",quoted(configured("SHADOW_GARDEN_URL","")))
