...
const developmentEffects = new Set(["life.meal.write", "life.meal.read", "life.purchase.write", "money.entry.write", "money.refund.write", "money.budget.write", "money.plan.write", "money.summary.read", "money.entry.read", "health.measurement.write", "health.raw.ingest", "health.measurement.read", "travel.trip.write", "travel.reservation.write", "travel.visit.write", "travel.trip.read", "library.source.link", "library.item.write", "library.item.read", "library.asset.read", "operations.read", "agent.run"]);
